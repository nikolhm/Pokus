...
def vassle_quest(qlog, spiller):
    ...
    q1 = Quest(desk1, ferdigDesk1, 1, 15, "Fjellhytta")
    ...
    q2 = Quest(desk2, ferdigDesk2, 1, 15, "Vulkanen")
    ...
    q3 = Quest(desk3, ferdigDesk3, 1, 15, "Slottet")
    ...
    q4 = Quest(desk4, ferdigDesk4, 1, 20, "Skogen", tilgjengelig=False)
